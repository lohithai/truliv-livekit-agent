...
def generate_agent_system_prompt(
    ...
    # Chennai areas removed from prompt to reduce token count.
    # Area matching is handled by STT keyword boosting + voice_find_nearest_property tool.
...
When the caller mentions an area name, pass it directly to voice_find_nearest_property. The tool handles matching.
